  ...
  return (
    <>
      <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 my-8 bg-gray-700">
        <h1 className="text-center text-white my-3 p-2">Password Generator</h1>
        ...
        <div className="flex text-sm gap-x-2">
          ...
          <div className="flex items-center gap-x-1">
            ...
            />
            <label className="text-orange-500">Number {numberAllowed}</label>
          </div>
          <div className="flex items-center gap-x-1">
            <input
              type="checkbox"
          ...
          <label className="text-orange-500">Character {charAllowed}</label>
        </div>
      </div>
    </>
  );
